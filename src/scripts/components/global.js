...
/* global Theme */
/* global Modernizr */
/* global LinkedOptions */
/* global ZoomView */
/* global VariantHelper */
/* global twitterFetcher */
/* global ImagePreloader */
/* global ThemeEditor */
/* global ProductView */
/* global ImagesWithText */
/* global VideoLoader */
/* global Instagram */
/* global rates */
/* global ArticleListView */
/* global AddressesView */
/* global QRCode */
/* global Flickity */
/* global target */
/* global SlideshowSection */
/* global HomeView */
/* global CollectionView */
/* global ListCollectionsView */
/* global GiftCardView */
/* global ContactView */
/* global AccordionView */
/* global CartView */
/* global BlogView */
/* global AccountView */
/* global NotFoundView */
...
/**
 * Taken from original theme.js file
 * 
 * Try and break this code out into their own components
 */
...
export default component((node, ctx) => {
  ...
  window.VariantHelper = (function() {
    ...
    VariantHelper.prototype._variantChange = function(event) {
      ...
      // sync shopify option selector
      console.log("here variant:", variant)
      if ($('.single-option-selector').length) {
        $(`.single-option-selector[data-option="option1"] option[value="${variant.option1}"]`).prop('selected', true);
        $(`.single-option-selector[data-option="option2"] option[value="${variant.option2}"]`).prop('selected', true);
        $(`.single-option-selector[data-option="option3"] option[value="${variant.option3}"]`).prop('selected', true);
  ...
  window.ProductView = (function(superClass) {
    ...
    ProductView.prototype.render = function() {
      ...
      // if (this.productJSON.type == "Pads") {
        this.customDropdownListToButtons();
      // }
      if (!this.$slideshow.length) {
        this.cacheImages();
      }
    ...
    ProductView.prototype.customDropdownListToButtons = function() {
      $('.custom-select-btns').each(function() {
      ...
      $('.custom-option:first-of-type').addClass('selection')
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(response) {
            var j, len, photo, photos, ref, sizes;
            if (response.meta.code === 200) {
              ...
              for (j = 0, len = ref.length; j < len; j++) {
                ...
                photos.push("<a class='instagram-photo' target='_blank' href='" + photo.link + "'><img src='" + sizes.small + "'/></a>");
              }
  ...
  window.SlideshowView = (function(superClass) {
    ...
    SlideshowView.prototype.initialize = function() {
      ...
      this.hasThumbnailPagination = this.$paginationContainer.length 
  ...
  window.ThemeView = (function(superClass) {
    ...
    ThemeView.prototype.initialize = function() {
      ...
      this.isProduct = body.attr('class').includes('product');
      this.isProductAlternate = body.hasClass('template-product-alternate');
    ...
    ThemeView.prototype.render = function() {
      ...
      if (this.isProduct || this.isProductSlideshow || this.isProductAlternate) {
        new ProductView({
          el: this.$el,
          bindSection: true
        });
